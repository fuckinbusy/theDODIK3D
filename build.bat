...
for %%P in (
    ...
    "E:\VisualStudio\Professional\MSBuild\Current\Bin\MSBuild.exe"
    "E:\VisualStudio\Community\MSBuild\Current\Bin\MSBuild.exe"
    "E:\VisualStudio\Enterprise\MSBuild\Current\Bin\MSBuild.exe"
) do (
